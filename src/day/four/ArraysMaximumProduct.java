 ...
 * @since 06-Dec-25
 */
public class ArraysMaximumProduct {

    /**
     * Returns the maximum product of any two distinct elements in the array using brute-force.
     *
     * @param arr the input array of integers
     *
     * @return the maximum product of any two elements, or Integer.MIN_VALUE if array has fewer than 2 elements
     */
    ...
    /**
     * Returns the maximum product of any two distinct elements in the array using sorting. Considers both the largest
     * and smallest pairs for negative values.
     *
     * @param arr the input array of integers
     *
     * @return the maximum product of any two elements, or Integer.MIN_VALUE if array has fewer than 2 elements
    ...
    /**
     * Returns the maximum product of any two distinct elements in the array using a single pass. Considers both the
     * largest and smallest pairs for negative values.
     *
     * @param arr the input array of integers
     *
     * @return the maximum product of any two elements, or Integer.MIN_VALUE if array has fewer than 2 elements
