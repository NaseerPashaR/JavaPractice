...
public class RepeatedWordFinder {
    ...
    /**
     * Find most repeated word string.
     *
     * @param input the input
     *
     * @return the string
     */
    public static String findMostRepeatedWord(final String input) {

        final List<String> uncommonWords = convertToUncommonWords(input);
        ...
        for (final String word : uncommonWords) {
        ...
        for (final String key : wordCountMap.keySet()) {
            final int currentValue = wordCountMap.get(key);
            if (currentValue > max) {
    ...
    /**
     * Convert input string to list of uncommon words
     *
     * @param input the input
     *
     * @return List of uncommon words
     */
    public static List<String> convertToUncommonWords(final String input) {

        final String lowercased = input.toLowerCase().trim();
        final String[] words = lowercased.split("[ \\n\\t\\r.,;:!?(){]");

        final List commonWords = List.of("the", "a", "or", "an", "it", "and", "but", "is", "are", "of", "on", "to", "was", "were", "in", "that", "i", "your", "his", "their", "her", "you", "me", "they", "at", "be");
    ...
    public static void main(final String[] args) {
        ...
        final var mostRepeatedWord = findMostRepeatedWord(testString);
